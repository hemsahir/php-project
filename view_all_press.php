...
$totalRes = $conn->query("SELECT COUNT(*) as total FROM press_releases $where");
$totalRows = $totalRes->fetch_assoc()['total'];
$totalPages = ceil($totalRows / $limit);
$data = $conn->query("SELECT * FROM press_releases $where ORDER BY notice_date DESC LIMIT $offset, $limit");
?>
...
<section id="press-fontSize" class="wrapper body-wrapper " style="font-size: 100%;">
